...
- "new google long-form about X" / "google branded long-form" / "long-form about google cloud next / I/O / gemini / gemma / TPU / DeepMind / Workspace / Android / Pixel" / "article-response long-form about a google.com / cloud.google.com / deepmind.google post" / "google keynote recap"
- "/diy-yt-creator:new-long-form-google …"
...
| [new-long-form-google.md](./new-long-form-google.md) | `templates/long-form/google/` | User wants a horizontal YouTube long-form (1920x1080, 30fps, 4-15 min) in the **Google brand cinematic** aesthetic — near-black `#0C0C0E` stage washed by four Google-color corner glows (blue NW / red NE / yellow SE / green SW) + canonical four-color rotation (blue `#4285F4` / red `#EA4335` / yellow `#FBBC04` / green `#34A853`) + Google wordmark top-right watermark (180×180, `top:-20, right:30` per V2 Remotion reference) + Google-blue → cyan progress bar + Inter type. Ships 8 scene archetypes (hook red+yellow / image-hero / side-by-side blue+yellow / stat-pill red+yellow / source-cards blue/red/yellow / video-embed / architecture-stack blue/red/yellow/green/cyan / CTA red subscribe). Best for Google Cloud Next / I/O recaps, Gemini / Gemma launches, Workspace AI explainers, Android / Pixel software releases, TPU / DeepMind walkthroughs, any article response to a `google.com` / `cloud.google.com` / `deepmind.google` post. |
