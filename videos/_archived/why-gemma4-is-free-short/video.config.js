...
window.VIDEO_CONFIG = {
  ...
  dynamous: {
    ...
    discountBubble: true,
    discountBubbleStart: 143.04,    // Phase 4 entrance (recomputed from transcript)
    discountBubbleDuration: 25,     // covers full Phase 4, fades just before endcard at 169.2
