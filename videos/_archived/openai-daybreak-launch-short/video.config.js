...
window.VIDEO_CONFIG = {
  ...
  dynamous: {
    ...
    discountBubble: true,
    discountBubbleDuration: 6.0,        // visible 122.6 → 128.6s (after REQUEST A SCAN pill, fades before endcard)
    discountBubbleStart: 122.6,         // recomputed Phase 4 mini-pill entrance for the 140s timeline
